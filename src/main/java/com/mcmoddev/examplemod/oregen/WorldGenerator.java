...
public class WorldGenerator implements IWorldGenerator {
	...
	public void addOre(Block oreBlock, int dimension, int minHeight, int maxHeight, int nodeSize) {
		this.myOres.add(new MineableOre(oreBlock.getDefaultState(), minHeight, maxHeight, dimension, nodeSize));
	}
	
	public void addOre(IBlockState oreBlock, int dimension, int minHeight, int maxHeight, int nodeSize) {
